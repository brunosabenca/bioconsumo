...
<div class="container-fluid">
    ...
    <div v-if="creating" v-cloak class="m-4">
        <new-product-view :sellers="{{ $sellers }}" inline-template
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <button class="btn btn-primary" @click="postAddNewProduct">Submit</button>
                </div>
            </div>
        </new-product-view>
    </div>
    ...
    <div class="row" >
        <div class="col-sm-12 col-md-6 col-lg-4" v-for="product in filteredItems(items, seller_id)" :key="product.id">
            <product-listing-item :product="product" v-on:deleted="removeProduct(product)" class="m-4"></product-listing-item>
        </div>
    </div>
</div>
